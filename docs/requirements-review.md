...
1. **完成 Gate 0**：21 節現有 12 項待決策中，第 1（基準機型）、2（預設掃描模式）、3（成本上限）、5（換頁即中斷）四項是 T00A/T01 的直接輸入，優先定案。
2. **啟動 T00A（contracts）**：schema、contentHash test vectors、座標契約與 ReaderSession scenario fixtures 不依賴任何 Apple API，可立即在本 repo 開工。
3. **T07 與 T09 兩個 Spike 並行**：兩者是互不依賴的最高風險項，串行會白白拉長時程。
...
- v0.3 → v0.4：併入第 6 節四項產品決策（涉及 2、3.2、4.2、5.2、6.7、6.9、7.1、9.1、12.2、16.4、20、21、22 節）。
